...
<div class="tabs-with-content">
  <div class="tabs is-fullwidth">
    <ul>
      <li class="{activeBody}"><a data-index="0" href="javascript:void(0)" on:click={tabSelect}>Body</a></li>
      <li class="{activeSchema}"><a data-index="1" href="javascript:void(0)" on:click={tabSelect}>Schema</a></li>
    </ul>
  </div>
  <div>
